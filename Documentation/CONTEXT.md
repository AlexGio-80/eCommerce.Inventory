...
- **Storico dei prezzi (2026-08-29)**: tabella `PriceHistoryEntries` alimentata dalla sincronizzazione notturna, che scarica gia' l'export completo e quindi non consuma chiamate API. Registra prezzo e quantita' solo quando cambiano, piu' un primo punto per ogni inserzione. Dal 2026-09-05 alimenta il grafico nella pagina "Nuovo Prodotto" (vedi sotto)

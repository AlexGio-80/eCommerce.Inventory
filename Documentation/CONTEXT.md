...
- **Punti di sicurezza — tutti chiusi il 2026-08-29**, codice in produzione e operazioni sul database eseguite:
  ...
  - **Verificato il 2026-09-05**: il webhook non era instradato dall'esterno per niente. Nessun `webhook_url` mai registrato su Card Trader, e comunque non ci sarebbe stato un percorso funzionante fino alla macchina (Kestrel solo su loopback, IIS senza reverse proxy verso `:5152`). Da registrare l'URL e sistemare l'esposizione (vedi ROADMAP.md)

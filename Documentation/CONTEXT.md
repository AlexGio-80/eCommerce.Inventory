...
**Ultimo aggiornamento:** 2026-09-05 (sessione 16 — deployate e verificate in produzione: firma obbligatoria sul webhook Card Trader, "Applica comunque" per bypassare il guardrail dalla scheda Storico, filtro per Origine nella scheda Esecuzioni. Deciso anche che l'autopricer è uscito dal dry-run (gira in modalità reale da alcune notti). Non ancora deployato: grafico storico prezzi + link Card Trader + nome italiano/numero di raccolta nella pagina "Nuovo Prodotto". Sessione 15: filtro "solo venditori Cardtrader Zero" nell'autopricer, non ancora deployato. Sessione 14: autopricer lanciabile a mano durante il giorno, con esecuzione in background; anteprima filtrabile per fascia ed espansione; applicazione delle sole carte selezionate. Sessione 13: riprezzo delle carte appena pubblicate, collegamento a Card Trader nelle griglie, fix salvataggio del profilo. Sessione 12: sicurezza, API chiusa per difetto)
